...
<c:set var="cate_id" value="${param.cate_id }" /> <%-- mav.addObject("cate_id", contentsVO.getCateno()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?cate_id=${cate_id}'" class="btn btn-info btn-sm">새로운 컨텐츠 등록</button>
        <button type='button' onclick="location.href='./list_by_cate_id.do?cate_id=${cate_id}&now_page=1'" class="btn btn-info btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_cate_id_grid.do?cate_id=${cate_id}&now_page=1'" class="btn btn-info btn-sm">갤러리 목록</button>
      </LI>
    </UL>
  </fieldset>
