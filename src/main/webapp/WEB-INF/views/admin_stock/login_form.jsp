  ...
  <DIV class='title_line'>관리자 로그인</DIV>
    ...
    <DIV style='width: 40%; margin: 0px auto;'>
      <FORM name='frm' method='POST' action='./login.do'>
         ...
         <label>아이디:</label>
         <input type='text' class="form-control" name='admin_id' id='admin_id' required="required" 
        ...
        <div class="form_input_bottom">
          <button type="submit" class="btn btn-info" style="color: white;">로그인</button>
          <button type="button" onclick="history.back();" class="btn btn-info" style="color: white;">취소</button>
        </div>
      </FORM>
    </DIV>
